...
class PartitionManifest(BaseModel):
    ...
    coverage_interval_start: str | None = Field(None, description="ISO datetime or date")
    coverage_interval_end: str | None = None
    ...
    missingness_pct: float | None = Field(None, ge=0, le=100)
    geography: str | None = Field(None, description="District or region code")
