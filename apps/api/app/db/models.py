...
class TransitRoute(Base):
    ...
    agency_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    ...
    validation_note: Mapped[Optional[str]] = mapped_column(String, nullable=True)
...
class TransitRouteStop(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    route_id: Mapped[str] = mapped_column(String, ForeignKey("transit_routes.route_id"), nullable=False, index=True)
    stop_id: Mapped[str] = mapped_column(String, ForeignKey("transit_stops.stop_id"), nullable=False, index=True)
    stop_sequence: Mapped[int] = mapped_column(Integer, nullable=False)
    direction_id: Mapped[Optional[str]] = mapped_column(String, nullable=True)
...
class TransitRouteShape(Base):
    ...
    route_id: Mapped[str] = mapped_column(String, ForeignKey("transit_routes.route_id"), nullable=False, index=True)
    variant_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    geom_geojson: Mapped[Optional[dict]] = mapped_column(JSONB, nullable=True)
    source_provider: Mapped[str] = mapped_column(String, nullable=False)
    source_family: Mapped[str] = mapped_column(String, nullable=False)
    source_status: Mapped[str] = mapped_column(String, nullable=False)
    fetched_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
...
class OfficialAlert(Base):
    ...
    affected_mode: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    affected_route_id: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    affected_station_id: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    alert_category: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    severity: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    effective_start: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
...
class AnomalyRecord(Base):
    ...
    segment_ids: Mapped[Optional[list[str]]] = mapped_column(ARRAY(String), nullable=True)
...
class ForecastSnapshotRecord(Base):
    ...
    segment_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    payload: Mapped[dict] = mapped_column(JSONB, nullable=False)
