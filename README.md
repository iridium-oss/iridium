...
[![License: EUPL-1.2](https://img.shields.io/badge/License-EUPL--1.2-blue.svg?logo=european-union&logoColor=white)](https://joinup.ec.europa.eu/collection/eupl/eupl-text-eupl-12)
[![CI](https://img.shields.io/github/actions/workflow/status/iridium-oss/iridium/ci.yml?branch=main&logo=github-actions&logoColor=white&label=CI)](https://github.com/iridium-oss/iridium/actions/workflows/ci.yml)
...
[![GitHub last commit](https://img.shields.io/github/last-commit/iridium-oss/iridium?logo=git&logoColor=white)](https://github.com/iridium-oss/iridium/commits/main)
[![GitHub repo size](https://img.shields.io/github/repo-size/iridium-oss/iridium?logo=files&logoColor=white)](https://github.com/iridium-oss/iridium)
[![GitHub commit activity](https://img.shields.io/github/commit-activity/m/iridium-oss/iridium?logo=git&logoColor=white)](https://github.com/iridium-oss/iridium/graphs/commit-activity)
[![GitHub top language](https://img.shields.io/github/languages/top/iridium-oss/iridium?logo=python&logoColor=white)](https://github.com/iridium-oss/iridium)
